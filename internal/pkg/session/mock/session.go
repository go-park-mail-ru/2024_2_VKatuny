...
//
//	mockgen -source=internal/pkg/session/session.go -destination=internal/pkg/session/mock/session.go -package=mock
//
...
func (mr *MockISessionRepositoryMockRecorder) Delete(arg0 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockISessionRepositoryMockRecorder) GetUserIdBySession(arg0 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockISessionUsecase) CheckAuthorization(ctx context.Context, userType, sessionID string) (uint64, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CheckAuthorization", ctx, userType, sessionID)
	ret0, _ := ret[0].(uint64)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockISessionUsecaseMockRecorder) CheckAuthorization(ctx, userType, sessionID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CheckAuthorization", reflect.TypeOf((*MockISessionUsecase)(nil).CheckAuthorization), ctx, userType, sessionID)
}

// Login mocks base method.
func (m *MockISessionUsecase) Login(ctx context.Context, form *dto.JSONLoginForm) (*dto.UserWithSession, error) {
	m.ctrl.T.Helper()
...
func (mr *MockISessionUsecaseMockRecorder) Login(ctx, form any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Login", reflect.TypeOf((*MockISessionUsecase)(nil).Login), ctx, form)
}

// Logout mocks base method.
func (m *MockISessionUsecase) Logout(ctx context.Context, userType, sessionID string) (*dto.JSONUser, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Logout", ctx, userType, sessionID)
...
func (mr *MockISessionUsecaseMockRecorder) Logout(ctx, userType, sessionID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Logout", reflect.TypeOf((*MockISessionUsecase)(nil).Logout), ctx, userType, sessionID)
}

...
insert into creation_type (id, creation_type_name) values (1, 'png');
...
values (1, 'Иван', 'Иванов', 1, '12-12-2001', 'IvanovIvan.png', 'tg - @IvanovIvan', 'МАРХИ', 'ivanovivan@mail.ru', '23e16c2f9af678bd3485cb9ccf8b6e8e');
...
values (1, 'Петр', 'Петров', 1, 'Помощник мэра', 1, 'Мэрия Москвы', 'https://www.mos.ru/', 'PetrPetrov.png', 'tg - @PetrPetrov', 'petrovpetr@mail.ru',  'a95e46339b08617435e0cf390bcce5ff');
insert into work_type (id, work_type_name) values (1, 'Полная занятость');
insert into cv (id, applicant_id, position_rus, position_eng, job_search_status_id, working_experience, path_to_profile_avatar)
values (1, 1, 'Скульптор', 'Engineer', 1,  'Не было опыта работы', 'IvanovIvan.png');
...
insert into vacancy (id, employer_id , salary, position, vacancy_description, work_type_id, path_to_company_avatar)
values (1, 1, 90000, 'Скульптор', 'Требуется скульптор без опыта работы', 1, 'logoBMSTU.png');
...
values (1, 1, 'Скульптура сократа', 'Socrates.png', 1);
...
delete from creation_type where creation_type_name='png';
